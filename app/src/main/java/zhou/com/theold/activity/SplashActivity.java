...
import zhou.com.theold.utils.StreamUtil;
...
//		startActivity(intent);
    ...
    private void initSelect() {
        ...
        String joint = "_t="+_t+"&opt="+opt+ConstantValue.APP_ENCRYPTION_KEY;
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                FileDataUtil.saveDataToFile(getApplicationContext(),str,"select_old_man");
            }
        });
    }
    ...
    private void initCityTown() {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                String str = response.body().string();
                //System.out.println(str);
                FileDataUtil.saveDataToFile(getApplicationContext(),str,"city_town_name");
            }
        });
    }
    ...
    private void initData() {
        //1,应用版本名称
        tv_version_name.setText("老人管理:" + getVersionName());
...
//			mHandler.sendMessageDelayed(msg, 4000);
    ...
    private void enterHome() {
        String guild_over = SpUtil.getString(getApplicationContext(), ConstantValue.GUILD_OVER, "");
        /*if(guild_over.isEmpty()){
            Intent intent = new Intent(this,GuideActivity.class);
        }
        Intent intent = new Intent(this,LoginActivity.class);*/
        Intent intent = new Intent(this,LoginActivity.class);//到时候改回来上面的
        startActivity(intent);
